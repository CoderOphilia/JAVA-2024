...
public class Employee {
	...
	public static int empCount = 0; //static field: Only one copy exists. 
	//The static field will not create variables for every object
	//the static field keeps on updating
	//all objects can access this static variable
	//Important: static objects are accessed by the class name
